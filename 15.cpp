...
int main(){
    ...
    vector<int> p = string_to_bigint(to_string(1));
    rng(i,2,41){
        vector<int> q = string_to_bigint(to_string(i));
        p = multiplication(p,q);
    }
    vector<int> v = string_to_bigint(to_string(1));
    rng(i,2,21){
        vector<int> u = string_to_bigint(to_string(i));
        v = multiplication(v,u);
    }
    vector<int> g = multiplication(v,v);
    cout << bigint_to_string(division(p,g)) << endl;
